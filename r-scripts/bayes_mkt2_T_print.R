...
print(xtable(mkt2_v2f_tbl$summary, type = "latex"), file = "exported_tables/bayes_mkt2_v2f_T.tex")

mkt2_v2r_tbl <- summary(mkt2_v2r)
print(xtable(mkt2_v2r_tbl$summary, type = "latex"), file = "exported_tables/bayes_mkt2_v2r_T.tex")

mkt2_v2a_tbl <- summary(mkt2_v2a)
print(xtable(mkt2_v2a_tbl$summary, type = "latex"), file = "exported_tables/bayes_mkt2_v2a_T.tex")

...
var_mkt1 <- mkt1[ , .(avgf_2f, avgf_2r, avg_gva, gjt_f)]
setnames(var_mkt1, old = c("avgf_2f", "avgf_2r", "avg_gva", "gjt_f"),
         new = c("2F", "2R", "g", "gamma"))
cor_mkt1 <- cor(var_mkt1)
...
fares_mkt2 <- mkt2[ , .(avgf_2f, avgf_2r, avgf_2a, avg_gva, gjt_f)]
setnames(fares_mkt2, old = c("avgf_2f", "avgf_2r", "avgf_2a", "avg_gva", "gjt_f"),
         new = c("2F", "2R", "2A", "g", "gamma"))
cor <- cor(fares_mkt2)
...
fares_mkt1 <- mkt1[ , .(avgf_1f, avgf_1r, avgf_1a, avgf_2f, avgf_2r, avgf_2a)]
setnames(fares_mkt1, old = c("avgf_1f","avgf_1r", "avgf_1a", "avgf_2f", "avgf_2r", "avgf_2a"),
...
mkt1[ , .(avgf_1f, avgf_1r, avgf_1a, avgf_2f, avgf_2r, avgf_2a)] %>% ggpairs()

...
load("bayes_simulation_mkt1_T.RData")
...
print(xtable(mkt1_v2f_tbl$summary, type = "latex"), file = "exported_tables/bayes_mkt1_v2f_T.tex")

mkt1_v2r_tbl <- summary(mkt1_v2r)
print(xtable(mkt1_v2r_tbl$summary, type = "latex"), file = "exported_tables/bayes_mkt1_v2r_T.tex")

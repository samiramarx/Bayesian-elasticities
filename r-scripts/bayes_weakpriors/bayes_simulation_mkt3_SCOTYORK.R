...
mkt3_v1n <- stan(file = "scripts/stan_models/stan_model_mkt3_v1n.stan", 
                 ...
                 chains = chains, 
                 iter = iter)
save(mkt3_v1n, file = "bayes_simulation_mkt3_v1n_SCOTYORK.RData")
...
mkt3_v2f <- stan(file = "scripts/stan_models/stan_model_mkt3_v2f.stan", 
                 ...
                 chains = chains, 
                 iter = iter)
save(mkt3_v2f, file = "bayes_simulation_mkt3_v2f_SCOTYORK.RData")
...
mkt3_v2r <- stan(file = "scripts/stan_models/stan_model_mkt3_v2r.stan", 
                 ...
                 chains = chains, 
                 iter = iter)
save(mkt3_v2r, file = "bayes_simulation_mkt3_v2r_SCOTYORK.RData")
...
mkt3_v2a <- stan(file = "scripts/stan_models/stan_model_mkt3_v2a.stan", 
                 ...
                 chains = chains, 
                 iter = iter)
save(mkt3_v2a, file = "bayes_simulation_mkt3_v2a_SCOTYORK.RData")

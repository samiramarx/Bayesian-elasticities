...
fit <- stan(file = "scripts/model1.stan", data = dta, cores = 1, chains = 2, iter = 10000)
...
known_parameters <- data_frame(variable = c(paste0("beta[",1:k,"]"),"sigma"), real_value = c(b0, b1, sigma))
